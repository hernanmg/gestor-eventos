        ...
        <form onSubmit={handleSubmit} className="space-y-3 mt-1">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input type="number" min="0" step="0.01" value={form.monto_total} onChange={e => set('monto_total', e.target.value)} className={inputCls} />
            </div>
          </div>
          <div className="grid grid-cols-2 gap-3">
            <div>
            ...
            <div>
              ...
              <input
                type="number" min="0" step="0.01" value={form.monto_cuota}
                onChange={e => set('monto_cuota', e.target.value)}
                placeholder={cuotaEstimada !== null ? String(cuotaEstimada) : '0.00'}
                className={inputCls}
              />
...
function PrestamosSection({ empleadoId }: { empleadoId: number }) {
